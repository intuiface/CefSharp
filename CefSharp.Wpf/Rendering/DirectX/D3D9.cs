    ...
    public class D3D9 : D3D
    {
        ...
        public D3D9(DeviceEx device) 
        {
            ...
            else
            {
                ...
                //this.m_device = new Device(new SharpDX.Direct3D9.Direct3D(), 0, DeviceType.Hardware, GetDesktopWindow(), CreateFlags.HardwareVertexProcessing, new PresentParameters(640, 480) { PresentationInterval = PresentInterval.One });
